...
type SecgroupRuleParameters struct {
	...
	// Reference to a Secgroup to populate securityGroupId.
	// +kubebuilder:validation:Optional
	SecurityGroupIDRef *v1.Reference `json:"securityGroupIdRef,omitempty" tf:"-"`

	// Selector for a Secgroup to populate securityGroupId.
	// +kubebuilder:validation:Optional
...
// SecgroupRule is the Schema for the SecgroupRules API. Manages a security group rule resource within VKCS.
